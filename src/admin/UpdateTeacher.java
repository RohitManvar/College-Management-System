    ...
    UpdateTeacher()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                lblrllno.setText(rs.getString("Employee_ID"));
                ...
                //c2.setText(rs.getString("Qualification"));
                //c1.setText(rs.getString("Department"));
                c3.setSelectedItem(rs.getString("Qualification"));
...
//        });
        crollno.addItemListener(new ItemListener(){
            ...
            while(rs.next())
            {
                ...
                //c2.setText(rs.getString("Qualification"));
                //c1.setText(rs.getString("Department"));
                c3.setSelectedItem(rs.getObject("Qualification"));
...
//            }
    ...
    if(ae.getSource().equals(update))
    {
            ...
            //String course = c2.getText();
            //String dep = c1.getText();
            
            String course = (String) c3.getSelectedItem();
            String dep = (String) d.getSelectedItem();
           
           
            String query= "UPDATE teacher set Name='"+name+"',Father_Name='"+fname+"', Employee_ID='"+rollno+"',Address='"+address+"',Phone_No='"+phone+"',Qualification='"+course+"',Department='"+dep+"',Email_ID='"+email+"',Password='"+pass+"' where Employee_ID='"+rollno+"'";
            try
            {
//                Conn c = new Conn();
...
//                }   
                Conn c = new Conn();
                c.s.executeUpdate(query);
                JOptionPane.showMessageDialog(null, "Teacher details are Upadate successfully");
                setVisible(false);
            }
            catch(Exception e)
            {
