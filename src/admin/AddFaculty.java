...
public class AddFaculty extends JFrame implements ActionListener
{
    ...
    AddFaculty()
    {
        ...
        JLabel heading = new JLabel("Add New Faculty");
...
//        JLabel lblmidd = new JLabel("Middle Name : ");
//        lblmidd.setBounds(278,150,150,30);
//        lblmidd.setFont(new Font("serif",Font.BOLD,18));
//        add(lblmidd);
//
//        t1midd = new JTextField();
//        t1midd.setBounds(399,156,120,25);
//        t1midd.setFont(new Font("Monospaced",Font.BOLD,17));
//        add(t1midd); 
        ...
        JLabel lblrollno = new JLabel("EmployeeID No : ");
    ...
    if(ae.getSource() == submit)
        {
            ...
            //String branch1 = (String) cbbranch.getSelectedItem();
            
           
            String query = "INSERT INTO teacher (Name, Father_Name, Employee_ID, Address, Phone_No, Date_of_Birth, 10th_Per, 12th_Per, Aadhar_Card_No, Qualification, Department, Email_ID,Username,Password) VALUES ('" + name + "', '" + fname + "', '" + rollno + "', '" + address + "', '" + phone + "', '" + dob + "', '" + x + "', '" + xii + "', '" + aadhar + "', '" + course + "', '" + branch + "','"+email+"','"+unm+"','"+pass+"')";
            try 
            {
                Conn c = new Conn();
                if (t1nm.getText().equals("") || t1fnm.getText().equals("") || t1pass.getText().equals("") || t1usernm.getText().equals("") || labelempid.getText().equals("") || t1address.getText().equals("") || t1phone.getText().equals("") || t1email.getText().equals("") || t1x.getText().equals("") || t1xii.getText().equals("") || t1aadhar.getText().equals("") || c2.getSelectedItem().equals("") || c1.getSelectedItem().equals("")  ) 
                {
                ...
                else 
                {
                    ...
                    JOptionPane.showMessageDialog(null, "Faculty details are inserted successfully");
                    setVisible(false);
                } 
            } 
            catch (Exception e) 
