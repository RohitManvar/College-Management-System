...
//        }        
        try
        {
            Conn c = new Conn();
            Statement s=c.c.createStatement();
            ResultSet rs=s.executeQuery("select * from teacher where Username='"+um+"'");
            while(rs.next())
            {
            l1.setText(rs.getString("Name"));           
            l2.setText(rs.getString("Father_Name"));
            lrllno.setText(rs.getString("Employee_ID"));
            ...
            lco.setText(rs.getString("Qualification"));
