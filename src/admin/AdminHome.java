...
public class AdminHome extends JFrame implements ActionListener {
    ...
    // Custom colors matching login design
    ...
    private JButton btnAddStudent, btnAddFaculty, btnStudentDetails, btnFacultyDetails;
    private JButton btnBachelorCourse, btnMasterCourse, btnExamDetails, btnEnterMarks;
    private JButton btnUpdateStudent, btnUpdateFaculty, btnNotepad, btnCalculator, btnExit;
    
    public AdminHome() {
        super("College Management System - Admin Dashboard");
    ...
    private void initializeComponents() {
        ...
        lblUserInfo = new JLabel("Logged in as: Admin");
        ...
        btnAddFaculty = createSidebarButton("Add Faculty", "icons/add-faculty.png");
        btnStudentDetails = createSidebarButton("Student Details", "icons/student-details.png");
        btnFacultyDetails = createSidebarButton("Faculty Details", "icons/faculty-details.png");
        ...
        btnUpdateFaculty = createSidebarButton("Update Faculty", "icons/update-faculty.png");
        ...
        btnExit = createSidebarButton("Exit", "icons/exit.png");
    }
    ...
    private void setupSidebar() {
        ...
        addSidebarSection(sidebarContent, "FACULTY MANAGEMENT", 
                         btnAddFaculty, btnFacultyDetails, btnUpdateFaculty);
        
        addSidebarSection(sidebarContent, "ACADEMIC", 
                         btnBachelorCourse, btnMasterCourse, btnExamDetails, btnEnterMarks);
    ...
    private void setupMainContent() {
        ...
        // Add dashboard cards
        addDashboardCard("Students", "Manage student records", PRIMARY_COLOR, "👨‍🎓");
        addDashboardCard("Faculty", "Manage faculty information", ACCENT_COLOR, "👨‍🏫");
        ...
        addDashboardCard("Reports", "Generate reports", new Color(231, 76, 60), "📊");
        addDashboardCard("Settings", "System configuration", SECONDARY_COLOR, "⚙️");
            ...
            switch (command) {
                ...
                default:
                    JOptionPane.showMessageDialog(this, 
                        "Feature '" + command + "' is coming soon!", 
                        "Information", 
