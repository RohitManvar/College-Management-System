...
public class AdminHome extends JFrame implements ActionListener
{
   AdminHome()
   {
        ...
        JMenuItem facultyinfo  = new JMenuItem("New Add Faculty Data");
        ...
        JMenuItem facultydeatils  = new JMenuItem("Faculty Deatils");
        facultydeatils.setBackground(Color.WHITE);
        facultydeatils.addActionListener(this);
        details.add(facultydeatils);
     ...
     String msg = ae.getActionCommand();
       ...
       switch (msg) {
           ...
           case "New Add Student Data":
               ...
               break;
           case"New Add Faculty Data":
               new AddFaculty();
               break;
           case"Student Deatils":
               new StudentDeatils();
               break;
           case"Faculty Deatils":
               new FacultyDetails();
               break;
